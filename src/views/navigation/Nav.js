      ...
      <>
        <div className={color ? "nav" : "nav-opacity"}>
          ...
          <ul className={checkbox ? "hide" : "show"}>
            <li>
              <NavLink to="/Fruits-Shop/home" activeClassName="active">
                Home
              </NavLink>
            </li>
            <li>
              <NavLink to="/Fruits-Shop/about" activeClassName="active">
                About
              </NavLink>
            </li>
            <li>
              <NavLink to="/Fruits-Shop/shop" activeClassName="active">
                Shop
              </NavLink>
            </li>
            <li>
              <NavLink to="/Fruits-Shop/contact" activeClassName="active">
                Contact
              </NavLink>
            </li>
          </ul>
